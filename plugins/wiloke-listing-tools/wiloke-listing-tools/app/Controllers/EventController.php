...
class EventController extends Controller
{
    ...
    public function handleShowExpiredEvent($status)
    {
            ...
            <div class="event-detail-content_firstItem__3vz2x">
                ...
                switch ($aItem['type']) {
                    case 'map':
                        ...
                        ?>
                        <wil-toggle-controller btn-name="<?php echo esc_html__('Toggle', 'wilcity-listing-tools');
                        ?>" icon="fa fa-toggle-on">
                            <template v-slot:default="{isOpen}">
                                <component
                                    v-if="isOpen"
                                    :max-zoom="<?php echo abs($wiloke->aThemeOptions['single_event_map_max_zoom']); ?>"
                                    :min-zoom="<?php echo abs($wiloke->aThemeOptions['single_event_map_minimum_zoom']); ?>"
                                    :default-zoom="<?php echo abs($wiloke->aThemeOptions['single_event_map_default_zoom']); ?>"
