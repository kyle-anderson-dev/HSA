        ...
        <div v-show="toggle=='enable'">
            <div class="field">
                ...
                <div class="ui segment">
                    ...
                    <p>
                        <strong style="color: #ff6657;">
                            The promotion MUST BE unique and it SHOULD NOT contain special
                            character like space,&,$ and it SHOULD NOT contain Uppercase Character.
                        </strong>
                    </p>
                    <p>
                        <strong style="color: #ff6657;">
                            ...
                            <div class="dragArea__form-content">
                                <div class="two fields">
                                    <div class="field">
                                        ...
                                        <p><i>Please pay attention to Warning</i></p>
                                    </div>
                                    <div class="field">
