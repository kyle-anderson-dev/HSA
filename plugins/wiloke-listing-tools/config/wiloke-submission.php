    ...
    'configuration'  => [
        'fields' => [
            ...
            [
                ...
                'desc'    => esc_html__('This feature is used for Currency Format. Leave empty to use the default option. To find your country locale, please go to Google and search for [Your Country] locale',
            ...
            [
                'type'    => 'password',
                'heading' => esc_html__('Endpoint Secret (*)', 'wiloke'),
