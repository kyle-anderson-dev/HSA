...
trait ListingToolsGeneralConfig
{
	...
	protected function getHeroSearchFields($postType = '')
	{
		...
		$this->aUsedHeroSearchFields
			= GetSettings::getOptions(General::getHeroSearchFieldsKey($postType), false, true);
	...
	public function saveHeroSearchFields()
	{
		...
		if (!isset($_POST['data'])) {
			...
			SetSettings::setOptions(General::getHeroSearchFieldsKey($_POST['postType']), $_POST['data'], true);
		}
